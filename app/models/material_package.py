...
PACKAGE_DOCUMENTS = {
    ...
    # Skills Programme: same KM + PM documents as Full Qualification, but replaces ISA +
    # Final Exam with a single FISA (Final Integrated Summative Assessment) — now built.
