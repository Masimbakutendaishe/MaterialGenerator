...
from app.services.ai_service import generate_facilitator_guide_content, generate_model_answers_for_questions
from app.services.document_service import (
    _hex_to_rgb, _build_branded_cover, _add_branded_header_footer, _add_bottom_border,
    _element_text, DEFAULT_PRIMARY, DEFAULT_SECONDARY,
)
    ...
    for i, module in enumerate(km_modules, start=1):
        ...
        if real_content:
            ...
            for topic in module.get("topics", []):
                ...
                outcomes = topic.get("assessment_criteria") or [_element_text(el) for el in topic.get("elements") or []]
                content = generate_facilitator_guide_content(unit_name, outcomes, course_title=qualification_title, job_id=job_id)
