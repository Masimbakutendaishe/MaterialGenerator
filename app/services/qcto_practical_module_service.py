"""Builds the QCTO Practical Module document — cover page, TOC, per-module intro/purpose,
a sub-modules table, and per-unit content with Scope of Practical Skill framing, detailed
content, example/tip callouts, and exercises — matching the real structural pattern."""
