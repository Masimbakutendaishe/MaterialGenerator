...
def _add_sup_module_section(doc, module, module_index, primary, primary_hex, secondary):
    """Per-module exposure/observation guidance, data-driven from real work_experience_elements
    and guidelines — reframed for the supervisor's vantage rather than the learner's."""
