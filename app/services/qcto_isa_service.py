...
def _add_isa_traceability_table(doc, km_modules, pm_modules, wm_modules, link_lookup, primary, primary_hex, secondary):
    ...
    for module in km_modules:
        ...
        for topic in module.get("topics", []):
            ...
            # Performance record slot — filled in by the assessor recording this specific
            # learner's actual exam performance against this topic's criteria.
...
def build_qcto_isa_docx(title: str, syllabus_content: dict, organization_name: str = None,
    ...
    _add_branded_header_footer(doc, logo_bytes=logo_bytes, qualification_name=qualification_title, organization_name=organization_name, primary_hex=primary_hex, accreditation_info=accreditation_info, document_label="ISA Traceability Document")
