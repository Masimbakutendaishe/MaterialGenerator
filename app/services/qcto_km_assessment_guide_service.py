...
def build_qcto_km_assessment_guide_docx(title: str, syllabus_content: dict, organization_name: str = None,
    ...
    _add_branded_header_footer(doc, logo_bytes=logo_bytes, qualification_name=qualification_title, organization_name=organization_name, primary_hex=primary_hex, accreditation_info=accreditation_info, document_label="KM Assessment Guide")
