...
def _normalize_db_url(url: str) -> str:
    """Railway (and some other hosts) provide DATABASE_URL in the plain 'postgresql://'
    or legacy 'postgres://' format, which makes SQLAlchemy default to the psycopg2 driver.
    This project uses psycopg (v3) instead, so we rewrite the URL to explicitly request
    it — regardless of which format the host hands us."""
